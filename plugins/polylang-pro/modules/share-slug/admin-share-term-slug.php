...
class PLL_Admin_Share_Term_Slug extends PLL_Share_Term_Slug {
	...
	public function save_term( $term_id, $tt_id, $taxonomy ) {
		...
		// Backward compatibility WP < 4.4
		$cache_group = version_compare( $GLOBALS['wp_version'], '4.4alpha', '<' ) ? $taxonomy : 'terms';

		wp_cache_delete( $term_id, $cache_group ); // forces deleting the get_term cache

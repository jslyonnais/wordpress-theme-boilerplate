...
## 1. Installing Wordpress
 ...
 - Setup a local URL (ex.: `dev.example.com`).
...
## 2. Setup Envionment
 - Open my `template.wp-config.php`, grab infos under `if(stristr( $_SERVER['SERVER_NAME'], "dev" )) { # Dev` and paste on yours.
...
## 4. Let's start!
- Go to your plugin tabs, and active all of them (you can remove Askimet and hello plugin :P)
-
